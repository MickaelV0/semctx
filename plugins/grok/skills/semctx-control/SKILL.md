...
Host plugins expose `semctx_control_agent_lifecycle` through the same Semctx MCP runtime.
...
<!-- BEGIN host-cli-ladder:grok -->
Prefer MCP tools when they are connected. For shell fallbacks, resolve the plugin-bundled
