...
Run `bunx semctx@0.3.0 --version`. Semctx 0.3.0 requires Bun >=1.4.0. If a global `semctx` command
...
Confirm the workflow pins `hoklims/semctx/packages/github-action@v0.3.0`, fetches full Git history,
